...
const ProductCardSecondary = ({
  ...
  let handleClick = () => {
    ...
    if (isInCart) {
      //TODOS : need to fix their types > temporarity set to (!)
      ...
      <div className="flex flex-col justify-between w-full gap-2 px-4 py-3  md:h-[24em]">
        <div className="flex flex-col gap-0">
          ...
          <div className="flex gap-1">
            <span className="px-2 py-[3px] rounded-md text-emerald-600 font-medium text-[0.6em] bg-emerald-200/40 w-fit mb-1">
              New
            </span>
            <span className="px-2 py-[3px] rounded-md text-blue-600 font-medium text-[0.6em] bg-blue-200/40 w-fit mb-1">
              Sale
            </span>
          </div>
